package com.king.app.jgallery.view.widget.extend;
...
/**
 * 源码copy from FastScroller
 * @description: 实现固定fastScroll滑块高度：在 updateScrollPosition 方法中修改mVerticalThumbHeight为固定值
 * @author：Jing
 * @date: 2020/11/21 23:45
 */
public class FixedFastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public FixedFastScroller(RecyclerView recyclerView, StateListDrawable verticalThumbDrawable,
        ...
        mShowHideAnimator.addListener(new FixedFastScroller.AnimatorListener());
        mShowHideAnimator.addUpdateListener(new FixedFastScroller.AnimatorUpdater());
    ...
    void updateScrollPosition(int offsetX, int offsetY) {
        ...
        if (mNeedVerticalScrollbar) {
            ...
            // @author JingYang 修改滑块高度为固定值
            //            mVerticalThumbHeight = Math.min(verticalVisibleLength,
//                    (verticalVisibleLength * verticalVisibleLength) / verticalContentLength);
            mVerticalThumbHeight = mRecyclerView.getResources().getDimensionPixelSize(R.dimen.fast_scroll_height);
        }
